...
insert  into `banks`(`id`,`nombre`,`cuenta`,`moneda`,`monto`,`created_at`,`updated_at`) values 
(1,'BMSC','123456789','BS',119000.00,NULL,NULL);
...
insert  into `buy_sells`(`id`,`fecha_descarga`,`fecha_compra`,`hora_descarga`,`cantidad`,`nro_compra`,`factura`,`papeleria`,`adicional`,`debito_banco`,`vehiculo`,`chofer`,`responsable`,`observaciones`,`tipo`,`bank_id`,`tank_id`,`created_at`,`updated_at`) values 
(1,'2022-01-21','2022-01-20',NULL,5000.00,NULL,NULL,3.00,NULL,6000.00,NULL,NULL,NULL,NULL,'Compra',1,3,NULL,NULL);
...
(22,'2022_01_18_151857_create_banks_table',2),
(23,'2022_01_18_153500_create_buy_sells_table',2);
