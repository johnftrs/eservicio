...
CREATE TABLE `asignations` (
  ...
  KEY `asignations_lot_id_foreign` (`lot_id`),
  CONSTRAINT `asignations_client_id_foreign` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE CASCADE,
  CONSTRAINT `asignations_lot_id_foreign` FOREIGN KEY (`lot_id`) REFERENCES `lots` (`id`) ON DELETE CASCADE
...
(18,'2021_12_14_224037_create_lots_table',1),
(19,'2021_12_14_224038_create_asignations_table',1),
(20,'2021_12_14_224040_create_tickets_table',1),
(21,'2021_12_14_224048_create_accountings_table',1),
(22,'2021_12_14_224115_create_humans_table',1),
(23,'2022_01_18_151857_create_banks_table',1),
(24,'2022_01_18_153500_create_buy_sells_table',1),
(25,'2022_01_25_102121_create_factors_table',1),
(26,'2022_01_25_102327_create_mensurations_table',1),
(27,'2022_01_27_092751_create_conciliations_table',1),
(28,'2022_01_27_093157_create_padlocks_table',1);
