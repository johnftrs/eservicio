<div class="card">
	...
	<div class="card-header primary-low">
		<h5 class="card-title"><i class="mdi mdi-clock"></i>Turnos</h5>
			...
			<table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						@if ($eliminar)
						<td class="centrado">
							<button type="button" wire:click="select({{$turn->id}})" class="btn btn-min danger"><i class="mdi mdi-trash-can-outline"></i>Borrar</button>
						</td>
						@endif
					</tr>
					@endforeach
	...
	<div class="modal-dialog panel primary visible">
		<div class="panel-heading">
			<h4 class="panel-title"><b style="color: white;">Registro de Turnos</b></h4>
			<a class="btn-close btn danger" wire:click="limpiar">&times;</a>
		</div>
		<div class="panel-body" >
			@include('admin.turn.forms.form')
		</div>
