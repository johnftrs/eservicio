...
<div class="card">
	<div class="card-header primary-low">
		@if (isset($order))
		<h5 class="card-title"><div>VALIDAR PEDIDO : {{$order->nombre_factura}}</div><div>PEDIDO: #{{$order->id}}</div></h5>
		@else
		<h5 class="card-title">Registro de Lote</h5>
		@endif
	</div>
	<div class="card-body">
		<form action="{{url('/admin/order/post/validar_pedido')}}" method="post" accept-charset="utf-8">
			{{ csrf_field() }}
