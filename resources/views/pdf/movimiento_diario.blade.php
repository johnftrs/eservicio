			...
			<table class="bb">
				<thead>
					<tr>
						...
						<th class="derecha meter">Meter Ini.</th>
						<th class="derecha meter">Meter Fin.</th>
						<th class="derecha cantidad">Cantidad</th>
						<th class="derecha precio">Precio</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="derecha">{{number_format($accountings->where('dispenser_id',$dis->id)->first() ? $accountings->where('dispenser_id',$dis->id)->first()->meter_inicial : 0, 2, ',', '.')}}</td>
						<td class="derecha">{{number_format($accountings->where('dispenser_id',$dis->id)->first() ? $accountings->where('dispenser_id',$dis->id)->first()->meter_final : 0, 2, ',', '.')}}</td>
						<td class="derecha">{{number_format($accountings->where('dispenser_id',$dis->id)->first() ? $accountings->where('dispenser_id',$dis->id)->sum('cantidad') : 0, 2, ',', '.')}}</td>
						<td class="derecha">{{$dis->fuel->precio_venta}}</td>
