		...
		<div class="panel default-soft">
			...
			<div class="panel-body centrado">
				...
				<div class="form-group">
					{!!Form::text('name',null,['class'=>'form-control', 'placeholder'=>'Name', 'required', 'maxlength'=>191,'autocomplete'=>'off'])!!}
				</div>
				<div class="form-group">
					{!! Form::email('email',null,['class'=>'form-control','placeholder'=>'Email' , 'required', 'maxlength'=>191,'autocomplete'=>'off','autocomplete'=>'off']) !!}
				</div>
				<div class="form-group">
					{!! Form::select('role_id', $roles, $user->role_id ?? null, ['class'=>'form-control centrado']) !!}
				</div>
				<div class="form-group">
